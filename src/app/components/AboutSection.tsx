...
export function AboutSection({ language }: AboutSectionProps) {
  ...
  return (
    <section id="about" ref={ref} className="py-24 lg:py-32 bg-[var(--dark-space)] relative overflow-hidden">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              ...
              >
                ...
                <div className="text-2xl text-[var(--foreground)] mb-1">{t.stats.projectsValue}</div>
