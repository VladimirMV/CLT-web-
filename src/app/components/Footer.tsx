        ...
        <div className="grid lg:grid-cols-4 gap-12 mb-12">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#solutions" className="text-[var(--neutral-gray)] hover:text-[var(--laser-blue)] transition-colors text-sm">
                  {t.productLinks.dazzler}
                </a>
              </li>
              <li>
                <a href="#solutions" className="text-[var(--neutral-gray)] hover:text-[var(--laser-blue)] transition-colors text-sm">
                  {t.productLinks.cameraKiller}
                </a>
              </li>
              <li>
                <a href="#solutions" className="text-[var(--neutral-gray)] hover:text-[var(--laser-blue)] transition-colors text-sm">
                  {t.productLinks.antiRecon}
                </a>
              </li>
              <li>
                <a href="#solutions" className="text-[var(--neutral-gray)] hover:text-[var(--laser-blue)] transition-colors text-sm">
                  {t.productLinks.nightVision}
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#applications" className="text-[var(--neutral-gray)] hover:text-[var(--laser-blue)] transition-colors text-sm">
                  {t.companyLinks.applications}
                </a>
              </li>
              <li>
                <a href="#advantages" className="text-[var(--neutral-gray)] hover:text-[var(--laser-blue)] transition-colors text-sm">
                  {t.companyLinks.whyUs}
                </a>
              </li>
            </ul>
          </div>
