...
export const translations = {
  EN: {
    ...
    about: {
      badge: 'About',
      title: 'Innovative Laser Defense Solutions',
      description: 'Our team has been developing laser-based systems for protecting ground assets from UAVs since 2025. Our solutions combine optical technologies with intelligent detection and tracking capabilities.',
      mission: 'OUR MISSION',
      missionText: 'is to develop effective and cost-efficient protection systems that help safeguard lives and critical infrastructure from aerial threats.',
      stats: {
        projects: 'Projects',
        projectsValue: 'TBA',
        countries: 'Countries',
    ...
    // Footer
    footer: {
      description: 'Innovative Laser Defense Solutions',
      products: 'Products',
      productLinks: {
  ...
  UA: {
    ...
    about: {
      badge: 'Про нас',
      title: 'Інноваційні лазерні рішення для захисту',
      description: 'Наша команда розробляє лазерні системи для захисту наземних об\'єктів від БПЛА з 2025 року. Наші рішення поєднують оптичні технології з інтелектуальними можливостями виявлення та супроводу.',
      mission: 'НАША МІСІЯ',
      missionText: 'полягає у розробці ефективних та економічно вигідних систем захисту, які допомагають захищати життя та критичну інфраструктуру від повітряних загроз.',
      stats: {
        projects: 'Проєктів',
        projectsValue: 'TBA',
        countries: 'Країн',
    ...
    // Footer
    footer: {
      description: 'Інноваційні лазерні рішення для захисту',
      products: 'Продукти',
      productLinks: {
        dazzler: 'LASER DAZZLER',
